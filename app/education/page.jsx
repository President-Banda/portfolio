...
const Education = () => {
  return (
    <>
    <div className="grid grid-cols-4 grid-rows-6 col-span-3 text-justify text-lg m-2 border border-solid border-sakura-light rounded-lg p-1 leading-relaxed">

        <div className="flex col-start-1 text-lg border border-solid border-sakura-light rounded-lg p-1 leading-relaxed glassmorphic-container w-0 ">
            <ol className="relative border-l border-gray-200 dark:border-gray-700 justify-end text-end">                   
